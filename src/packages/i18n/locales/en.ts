export default {
  ...
  landing: {
    ...
    hero_cta_primary: "Try Pro free for 7 days",
  ...
  ,musicscale: {
    ...
    trial_microcopy: "7 days free on Pro. Then R$34.90/month. Cancel before the trial ends to avoid being charged.",
    demo_guided_label: "Guided demo",
    faq_q7: "Can I try it before paying?",
    faq_a7: "Yes. Every plan includes a 7-day free trial with the features of the plan you choose. The main button starts a Pro trial, our complete plan. Cancel before the trial ends to avoid being charged.",
    ...
    final_cta_button: "Try Pro free for 7 days",
