export default {
  ...
  landing: {
    ...
    pricing_trial_plan_note: "Your 7-day trial follows the features and limits of the plan you choose.",
  ...
  ,musicscale: {
    ...
    trial_microcopy: "Choose your plan and try its own features and limits free for 7 days. Cancel before the trial ends to avoid being charged.",
    demo_guided_label: "Guided demo",
    faq_q7: "Can I try it before paying?",
    faq_a7: "Yes. Every plan includes a 7-day free trial with the features and limits of the plan you choose. Cancel before the trial ends to avoid being charged.",
