export default {
  ...
  landing: {
    ...
    pricing_trial_plan_note: "La prueba de 7 días respeta los recursos y límites del plan que elijas.",
  ...
  ,musicscale: {
    ...
    trial_microcopy: "Elige tu plan y prueba gratis durante 7 días sus propios recursos y límites. Cancela antes de que termine la prueba para evitar el cobro.",
    demo_guided_label: "Demostración guiada",
    faq_q7: "¿Puedo probarlo antes de pagar?",
    faq_a7: "Sí. Cada plan incluye 7 días de prueba gratis con los recursos y límites del plan elegido. Cancela antes de que termine la prueba para evitar el cobro.",
