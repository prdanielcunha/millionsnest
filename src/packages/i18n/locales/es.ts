export default {
  ...
  landing: {
    ...
    hero_cta_primary: "Probar Pro gratis por 7 días",
  ...
  ,musicscale: {
    ...
    trial_microcopy: "7 días gratis en Pro. Después, R$ 34,90/mes. Cancela antes de que termine la prueba para evitar el cobro.",
    demo_guided_label: "Demostración guiada",
    faq_q7: "¿Puedo probarlo antes de pagar?",
    faq_a7: "Sí. Cada plan incluye 7 días de prueba gratis con las funciones del plan elegido. El botón principal inicia la prueba del plan Pro, nuestro plan completo. Cancela antes de que termine la prueba para evitar el cobro.",
    ...
    final_cta_button: "Probar Pro gratis por 7 días",
