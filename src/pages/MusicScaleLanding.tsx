        ...
        <div className="max-w-7xl mx-auto relative z-10">
          <div className="flex flex-col items-center text-center">
            ...
            <motion.div
              ...
              className="mb-10 px-5 py-3 rounded-2xl bg-gradient-to-r from-[#2B85EB]/10 via-[#2B85EB]/5 to-transparent border border-[#2B85EB]/30 max-w-2xl flex items-center gap-3.5 backdrop-blur-md"
            >
